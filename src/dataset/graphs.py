...
class Graph():
    ...
    def _get_edge(self):
        if self.dataset == 'kinetics':
            ...
            connect_joint = np.array([2,21,21,3,21,5,6,7,21,9,10,11,1,13,14,15,1,17,18,19,2,23,8,25,12]) - 1
            parts = [
        ...
        elif self.dataset == 'H4AM':
            num_node = 32
            neighbor_1base = [(0, 1), (1, 2), (2, 3), (3, 26), (4, 2),
                              (5, 4), (6, 5), (7, 6), (8, 7), (9, 8),
                              (10, 7), (11, 2), (12, 11), (13, 12), (14, 13),
                              (15, 14), (16, 15), (17, 14), (18, 0), (19, 18),
                              (20, 19), (21, 20), (22, 0), (23, 22), (24, 23),
                              (25, 24), (26, 27), (27, 28), (28, 30), (29, 27),
                              (31, 29)]
            neighbor_link = neighbor_1base
            connect_joint = np.array([1,2,3,26,2,4,5,6,7,8,7,2,11,12,13,14,15,14,0,18,19,20,0,22,23,24,27,28,30,27,28,29])
            parts = [
                np.array([5, 6, 7, 8, 9, 10]),       # left_arm
                np.array([12, 13, 14, 15, 16, 17]),  # right_arm
                np.array([18, 19, 20, 21]),          # left_leg
                np.array([22, 23, 24, 25]),          # right_leg
                np.array([0, 1, 2, 3, 26])           # torso
            ]
